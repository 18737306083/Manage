          ...
          <ul class="nav nav-drawer">
           ...
           <!-- 人员管理开始 -->
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-palette"></i> <span>人员管理</span></a>
              <ul class="nav nav-subnav">
                <li> <a class="multitabs" href="lyear_ui_buttons.html">人员管理</a> </li>
              </ul>
            </li>
             <!-- 人员管理结束-->
            <!-- 就业信息管理开始 -->
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-format-align-justify"></i> <span>就业信息管理</span></a>
              <ul class="nav nav-subnav">
                <li> <a class="multitabs" href="lyear_forms_elements.html">校园宣讲</a> </li>
                 <li> <a class="multitabs" href="lyear_forms_elements.html">实习讯息</a> </li>
              </ul>
            </li>
             <!-- 就业信息管理结束 -->
          <!--邮箱管理开始  -->
           <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-format-align-justify"></i> <span>邮箱推送</span></a>
              <ul class="nav nav-subnav">
                <li> <a class="multitabs" href="lyear_forms_elements.html">邮箱推送</a> </li>
              </ul>
            </li>
             <!--邮箱管理结束  -->
          </ul>
...
<script type="text/javascript" src="<%=basePath%>js/bootstrap-multitabs/multitabs.js"></script>
<script type="text/javascript" src="<%=basePath%>js/index.min.js"></script>
</body>
</html>